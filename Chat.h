...
public:
	...
	void saveMessageToDatabase(int senderId, int receiverId, const std::string& message); // Добавленный метод
	std::vector<std::string> loadMessagesFromDatabase(int userId); // Добавленный метод
